...
__export(react_exports, {
  NextThumborImage: () => NextThumborImage,
  ThumborImage: () => ThumborImage
});
...
var ThumborImage = ({
  ...
  const srcSet = responsive ? getImageSrcSet(src, thumborOptions) : void 0;
  return import_react.default.createElement("img", {
    src: optimizedSrc,
    srcSet,
    sizes: responsive ? sizes : void 0,
    alt,
    width,
    height,
    loading,
...
var NextThumborImage = ({
  ...
  if (typeof window !== "undefined") {
    return import_react.default.createElement(ThumborImage, {
      src,
      thumborOptions,
      alt,
      width,
  ...
  try {
    ...
    return import_react.default.createElement(NextImage, {
      src: optimizedSrc,
      alt,
      width,
      height,
